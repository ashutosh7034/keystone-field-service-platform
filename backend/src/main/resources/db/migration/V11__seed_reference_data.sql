...
-- BCrypt hash for 'password123': $2a$10$sAY7ZO1xFYy0Nz1/rQlBxueY1ecu8U1qI9pJwwbF8AnI1Dz6PEObG
INSERT INTO users (id, email, password_hash, full_name, phone, role, customer_id, active, created_at, updated_at) VALUES
(1, 'manager@keystone.demo', '$2a$10$sAY7ZO1xFYy0Nz1/rQlBxueY1ecu8U1qI9pJwwbF8AnI1Dz6PEObG', 'Eleanor Vance (Operations Director)', '+1-555-1001', 'ROLE_MANAGER', NULL, TRUE, NOW() - INTERVAL '30' DAY, NOW()),
(2, 'dispatcher@keystone.demo', '$2a$10$sAY7ZO1xFYy0Nz1/rQlBxueY1ecu8U1qI9pJwwbF8AnI1Dz6PEObG', 'David Ross (Head Dispatcher)', '+1-555-1002', 'ROLE_DISPATCHER', NULL, TRUE, NOW() - INTERVAL '30' DAY, NOW()),
(3, 'technician1@keystone.demo', '$2a$10$sAY7ZO1xFYy0Nz1/rQlBxueY1ecu8U1qI9pJwwbF8AnI1Dz6PEObG', 'Alex Rivera (Lead HVAC Tech)', '+1-555-2001', 'ROLE_TECHNICIAN', NULL, TRUE, NOW() - INTERVAL '30' DAY, NOW()),
(4, 'technician2@keystone.demo', '$2a$10$sAY7ZO1xFYy0Nz1/rQlBxueY1ecu8U1qI9pJwwbF8AnI1Dz6PEObG', 'Sarah Chen (Master Electrician)', '+1-555-2002', 'ROLE_TECHNICIAN', NULL, TRUE, NOW() - INTERVAL '30' DAY, NOW()),
(5, 'technician3@keystone.demo', '$2a$10$sAY7ZO1xFYy0Nz1/rQlBxueY1ecu8U1qI9pJwwbF8AnI1Dz6PEObG', 'Marcus Vance (Commercial Plumber)', '+1-555-2003', 'ROLE_TECHNICIAN', NULL, TRUE, NOW() - INTERVAL '30' DAY, NOW()),
(6, 'customer1@keystone.demo', '$2a$10$sAY7ZO1xFYy0Nz1/rQlBxueY1ecu8U1qI9pJwwbF8AnI1Dz6PEObG', 'David Miller (Apex Facilities VP)', '+1-555-3001', 'ROLE_CUSTOMER', 1, TRUE, NOW() - INTERVAL '30' DAY, NOW()),
(7, 'customer2@keystone.demo', '$2a$10$sAY7ZO1xFYy0Nz1/rQlBxueY1ecu8U1qI9pJwwbF8AnI1Dz6PEObG', 'Elena Rostova (Metro Mall Director)', '+1-555-3002', 'ROLE_CUSTOMER', 2, TRUE, NOW() - INTERVAL '25' DAY, NOW()),
(8, 'customer3@keystone.demo', '$2a$10$sAY7ZO1xFYy0Nz1/rQlBxueY1ecu8U1qI9pJwwbF8AnI1Dz6PEObG', 'James Wilson (Horizon IT Infrastructure)', '+1-555-3003', 'ROLE_CUSTOMER', 3, TRUE, NOW() - INTERVAL '20' DAY, NOW());
